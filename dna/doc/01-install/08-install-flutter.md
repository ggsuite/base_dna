...
`dart`, which is needed to install [gg](./09-install-gg.md).

## Install on Mac

Make sure [brew is installed](./02-install-brew-on-mac.md)
...
[WSL and Ubuntu are installed](./02-install-wsl-and-ubuntu.md)
